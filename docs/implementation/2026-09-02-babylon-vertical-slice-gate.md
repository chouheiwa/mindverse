...
- 样片实现与测量提交：`7eac10a316f42960a770b7df4a1ef8f9fbc26140`
...
- 连续 5 次 enter/exit 后 RAF 仍为 1、监听器计数仍为 3、WebGL context 仍为 1。
...
- `VITE_RENDERER=babylon ... babylon-gate.spec.ts`：5/5 通过。
