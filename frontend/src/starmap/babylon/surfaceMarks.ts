 ...
 */
/**
 * `azimuthOffset`：整个扇面绕脚下法线转开的角度。有小径时把痕迹让到小径右侧，
 * 否则第一面旗正好插在路牌上。
 */
export function layoutSurfaceMarks(
  landing: Vec3, facing: Vec3, marks: readonly SurfaceMark[], azimuthOffset = 0,
): SurfaceMarkPlacement[] {
