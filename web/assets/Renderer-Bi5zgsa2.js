...
`,H=[{r:1,freq:3.4,warp:1.1,low:.1,high:.62,flat:1.45,dust:.55,gain:.24,spin:.0042},{r:1.62,freq:2.3,warp:.85,low:.16,high:.7,flat:1.05,dust:.38,gain:.17,spin:.0026},{r:2.45,freq:1.5,warp:.55,low:.24,high:.8,flat:.72,dust:.2,gain:.09,spin:.0015}],U=512;function te(e,t,n,r=U){let i=new S,a=[],o=[],s=[];H.forEach((c,l)=>{let u=re(e,r,{freq:c.freq,warp:c.warp,low:c.low,high:c.high,flat:c.flat,dust:c.dust,seed:3.7+l*17.3,colA:n[0],colB:n[1],colC:n[2]});a.push(u);let d=new v({uniforms:{uMap:{value:u.texture},uGain:{value:c.gain}},vertexShader:`
        varying vec3 vDir;
        void main() {
          vDir = position;
      ...
      `,side:1,blending:2,depthWrite:!1,depthTest:!1,transparent:!0});a.push(d);let f=new _(1,1,1);a.push(f);let p=new w(f,d);p.scale.setScalar(t*c.r*22),p.renderOrder=-40+l,p.frustumCulled=!1,p.rotation.set(l*1.31,l*2.17,l*.73),i.add(p),o.push({mesh:p,spin:c.spin}),s.push({u:d.uniforms.uGain,base:c.gain})});let c=ne(t,n[1]);return a.push(c.geometry,c.material),i.add(c),s.push({u:c.material.uniforms.uGain,base:1}),{group:i,update(e,t){o.forEach((t,n)=>{t.mesh.rotation.set(n*1.31,n*2.17+e*t.spin,n*.73)}),c.quaternion.copy(t.quaternion)},setDim(e){for(let t of s)t.u.value=t.base*e},dispose(){for(let e of a)e.dispose()}}}function ne(e,t){let n=new v({uniforms:{uTint:{value:t.clone()},uGain:{value:1}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,blending:2,depthWrite:!1,depthTest:!1,transparent:!0}),r=new w(new h(e*3.2,e*3.2),n);return r.renderOrder=-5,r.frustumCulled=!1,r}function re(e,t,a){let o=new b(t,{type:r,format:i,generateMipmaps:!1,minFilter:n,magFilter:n}),s=new v({uniforms:{uFreq:{value:a.freq},uWarp:{value:a.warp},uLow:{value:a.low},uHigh:{value:a.high},uFlat:{value:a.flat},uDust:{value:a.dust},uSeed:{value:a.seed},uColA:{value:a.colA.clone()},uColB:{value:a.colB.clone()},uColC:{value:a.colC.clone()}},vertexShader:`
      varying vec3 vDir;
      void main() {
        vDir = position;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function ge(e,t,n=oe(e)){let r=e.stars,i=r.length,o=new Float32Array(i*3),c=new Float32Array(i*3),l=new Float32Array(i*3),u=new Float32Array(i*3),d=new Float32Array(i*3),m=new Float32Array(i),h=new Float32Array(i),g=new Float32Array(i),_=new Float32Array(i),y=new Float32Array(i),b=new Float32Array(i),x=new Float32Array(i).fill(1),C=new Float32Array(i),w=new Float32Array(i);n.forEach((e,n)=>{o.set(e.p,n*3),l.set(e.center,n*3),u.set(e.axis,n*3),c.set(e.start,n*3),d.set(e.color,n*3),m[n]=e.period,h[n]=e.pointSize,g[n]=e.bright,_[n]=t?0:e.burst,y[n]=e.seed,b[n]=e.ignite,C[n]=e.rot,w[n]=e.bodyR});let E=new a;E.setAttribute(`position`,new s(o,3)),E.setAttribute(`aStart`,new s(c,3)),E.setAttribute(`aCenter`,new s(l,3)),E.setAttribute(`aAxis`,new s(u,3)),E.setAttribute(`aColor`,new s(d,3)),E.setAttribute(`aPeriod`,new s(m,1)),E.setAttribute(`aSize`,new s(h,1)),E.setAttribute(`aBright`,new s(g,1)),E.setAttribute(`aBurst`,new s(_,1)),E.setAttribute(`aSeed`,new s(y,1)),E.setAttribute(`aIgnite`,new s(b,1)),E.setAttribute(`aDim`,new s(x,1)),E.setAttribute(`aRot`,new s(C,1)),E.setAttribute(`aBodyR`,new s(w,1)),E.boundingSphere=new p(new f,1e6);let D={uT:{value:0},uConverge:{value:+!!t},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3},uIgniteMs:{value:700},uLitFloor:{value:+!!t},uBob:{value:t?0:1.35}},O=(e,t,n,r={})=>new v({uniforms:{...D,uSizeMul:{value:t},uGain:{value:n},uFlareShape:{value:0},uFadeToBody:{value:0},uNearMul:{value:7},uMaxPx:{value:520},...r},vertexShader:fe,fragmentShader:e,blending:2,depthWrite:!1,depthTest:!1,transparent:!0}),k=O(me,Z.glow,de.glow,{uNearMul:{value:7.5},uMaxPx:{value:520}}),A=O(pe,Z.core,de.core,{uFadeToBody:{value:1},uMaxPx:{value:90}}),ee=O(he,Z.flare,de.flare,{uThreshold:{value:Q},uFlareShape:{value:1},uNearMul:{value:26},uMaxPx:{value:360}}),j=new S;for(let[e,t]of[[k,10],[A,12],[ee,14]]){let n=new T(E,e);n.renderOrder=t,n.frustumCulled=!1,j.add(n)}let M=[k,A,ee],N=E.getAttribute(`aDim`);return{group:j,order:r,igniteEnd:X+i*62+1500,setUniform(e,t){for(let n of M)n.uniforms[e]&&(n.uniforms[e].value=t)},setDim(e,t,n){for(let a=0;a<i;a++)x[a]=ve(r[a],e,t,n);N.needsUpdate=!0},dispose(){E.dispose();for(let e of M)e.dispose()}}}function _e(e,t,n,r){switch(t){case`dark`:return n.dark.some(t=>t.c===e.c)?1:.08;case`nebula`:return n.nebula.some(t=>t.c===e.c)?1:.1;case`worm`:{let t=n.wormholes[r];return t&&(e.g===t.a||e.g===t.b)?1:.11}case`me`:return n.meta.own===0||e.o>0?1:.1;case`solo`:return .12;default:return 1}}function ve(e,t,n,r){let i=_e(e,t,n,r);return n.dark.some(t=>t.c===e.c)?Math.min(i,.3):i}var ye=.9,be=(e,t,n)=>Math.max(t,Math.min(n,e)),xe=(e,t,n)=>{let r=be((n-e)/Math.max(1e-6,t-e),0,1);return r*r*(3-2*r)};function Se(e){let t=be((e.far-e.viewZ)/Math.max(.001,e.far-e.near),0,1);return e.renderDim*xe(13,40,e.starPx)*xe(ye,1,e.convergence)*t*t}function Ce(e){return e.clipZ>=-1&&e.clipZ<=1&&Se(e)>.004}function we(e){let t=new Map;for(let n of e){let e=t.get(n.star);e?e.push(n):t.set(n.star,[n])}return t}function Te(e,t,n){return e.find(e=>`id`in e.star.s&&e.star.s.id===t&&e.question.id===n)??null}var Ee=2.1,De=1.15,Oe=.085,ke={star:1.9,planet:.92,ring:.1},Ae=`
${R}
${z}
attribute vec3 iPos;
...
`;function Ie(t,n){let r=t.universe,i=oe(r),a=i.length,c=new y(1,32,20),l=new o;l.index=c.index,l.setAttribute(`position`,c.getAttribute(`position`)),l.instanceCount=a;let d=new Float32Array(a*3),m=new Float32Array(a*3),h=new Float32Array(a*3),g=new Float32Array(a*3),_=new Float32Array(a*3),b=new Float32Array(a*4),x=new Float32Array(a*2);i.forEach((e,t)=>{d.set(e.p,t*3),m.set(e.center,t*3),h.set(e.axis,t*3),g.set(e.start,t*3),_.set(e.color,t*3),b.set([e.period,e.ignite,e.bodyR,e.seed],t*4),x.set([e.kelvin,1],t*2)}),l.setAttribute(`iPos`,new u(d,3)),l.setAttribute(`iCenter`,new u(m,3)),l.setAttribute(`iAxis`,new u(h,3)),l.setAttribute(`iStart`,new u(g,3)),l.setAttribute(`iColor`,new u(_,3)),l.setAttribute(`iOrb`,new u(b,4)),l.setAttribute(`iMeta`,new u(x,2)),l.boundingSphere=new p(new f,1e6);let T=()=>({uT:{value:0},uConverge:{value:+!!n},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3},uBob:{value:n?0:1.35}}),E=new v({uniforms:{...T(),uIgniteMs:{value:700},uLitFloor:{value:+!!n},uGain:{value:ke.star}},vertexShader:Ae,fragmentShader:je,transparent:!0,depthTest:!0,depthWrite:!0}),D=new w(l,E);D.renderOrder=9,D.frustumCulled=!1;let O=i.map(n=>e(t,n.s)),k=1/0,A=-1/0;for(let e of O)for(let t of e){let e=t.latestPublicAt;e!==void 0&&(e<k&&(k=e),e>A&&(A=e))}let ee=Math.max(1,A-k),j=e=>e===void 0||!Number.isFinite(k)||!Number.isFinite(A)?.45:Math.min(.999,Math.max(0,(e-k)/ee)),M=[];i.forEach((e,t)=>O[t].forEach((t,n)=>M.push({d:e,idx:n,datum:t,own:+!!t.created,fresh:j(t.latestPublicAt)})));let N=M.length,P=new Float32Array(N*3),F=new Float32Array(N*3),I=new Float32Array(N*3),L=new Float32Array(N*3),R=new Float32Array(N*3),z=new Float32Array(N*3),B=new Float32Array(N*4),V=new Float32Array(N*4),H=new Float32Array(N).fill(1),U=new Float32Array(N),te=new Int32Array(N),ne=[],re=new Map;i.forEach((e,t)=>re.set(e,t)),M.forEach((e,t)=>{let n=e.d,r=e.idx*2654435761%1e3/1e3-.5,[i,a]=Re(n.sysU,n.sysV,n.sysAxis,r*.22),o=Ee+e.idx*De,s=7+2.4*o**1.5,c=(e.idx*137.508+n.seed*31.7)*Math.PI/180,l=Oe+.115*Math.min(1,Math.log1p(e.datum.answerCount)/Math.log1p(30));P.set(i,t*3),F.set(a,t*3),I.set(n.p,t*3),L.set(n.center,t*3),R.set(n.axis,t*3),z.set(n.color,t*3),B.set([o,c,s,l],t*4),V.set([e.own*2+e.fresh,n.seed,n.bodyR,n.period],t*4),te[t]=re.get(n),ne.push({star:n,question:e.datum.question,answerCount:e.datum.answerCount,created:e.datum.created,collected:e.datum.collected,latestPublicAt:e.datum.latestPublicAt,answers:e.datum.answers,orbitIndex:e.datum.orbitIndex,index:t,u:i,v:a,orbitR:o,phase:c,period:s,radius:l})});let W=new y(1,20,14),G=new o;G.index=W.index,G.setAttribute(`position`,W.getAttribute(`position`)),G.instanceCount=N,Le(G,{pU:P,pV:F,pStarPos:I,pStarCenter:L,pStarAxis:R,pColor:z,pOrb:B,pMeta:V,pDim:H,pSel:U});let ie=new v({uniforms:{...T(),uGain:{value:ke.planet}},vertexShader:Me,fragmentShader:Ne,transparent:!0,depthTest:!0,depthWrite:!0}),K=new w(G,ie);K.renderOrder=9,K.frustumCulled=!1;let ae=new Float32Array(432);for(let e=0;e<72;e++){let t=e/72*Math.PI*2,n=(e+1)/72*Math.PI*2;ae.set([Math.cos(t),Math.sin(t),0,Math.cos(n),Math.sin(n),0],e*6)}let q=new o;q.setAttribute(`position`,new s(ae,3)),q.instanceCount=N,Le(q,{pU:P,pV:F,pStarPos:I,pStarCenter:L,pStarAxis:R,pColor:z,pOrb:B,pMeta:V,pDim:H,pSel:U});let J=new v({uniforms:{...T(),uGain:{value:ke.ring}},vertexShader:Pe,fragmentShader:Fe,transparent:!0,blending:2,depthTest:!1,depthWrite:!1}),Y=new C(q,J);Y.renderOrder=8.5,Y.frustumCulled=!1;let X=new S;X.add(Y,D,K);let se=[E,ie,J],ce=l.getAttribute(`iMeta`),le=G.getAttribute(`iDim`),ue=q.getAttribute(`iDim`),Z=G.getAttribute(`iSel`),de=q.getAttribute(`iSel`),Q=-1,fe=we(ne);return{group:X,data:i,planets:ne,planetsForStar:e=>fe.get(e)??[],setSelected(e){e!==Q&&(Q>=0&&(U[Q]=0),Q=e>=0&&e<N?e:-1,Q>=0&&(U[Q]=1),Z.needsUpdate=!0,de.needsUpdate=!0)},setUniform(e,t){for(let n of se)n.uniforms[e]&&(n.uniforms[e].value=t)},setMode(e,t,n){let r=i.map(r=>ve(r.s,e,t,n));for(let e=0;e<a;e++)x[e*2+1]=r[e];ce.needsUpdate=!0;for(let e=0;e<N;e++)H[e]=r[te[e]];le.needsUpdate=!0,ue.needsUpdate=!0},dispose(){c.dispose(),W.dispose(),l.dispose(),G.dispose(),q.dispose();for(let e of se)e.dispose()}}}function Le(e,t){e.setAttribute(`iU`,new u(t.pU,3)),e.setAttribute(`iV`,new u(t.pV,3)),e.setAttribute(`iStarPos`,new u(t.pStarPos,3)),e.setAttribute(`iStarCenter`,new u(t.pStarCenter,3)),e.setAttribute(`iStarAxis`,new u(t.pStarAxis,3)),e.setAttribute(`iColor`,new u(t.pColor,3)),e.setAttribute(`iOrb`,new u(t.pOrb,4)),e.setAttribute(`iMeta`,new u(t.pMeta,4)),e.setAttribute(`iDim`,new u(t.pDim,1)),e.setAttribute(`iSel`,new u(t.pSel,1)),e.boundingSphere=new p(new f,1e6)}function Re(e,t,n,r){let i=Math.cos(r),a=Math.sin(r),o=[e[0]*i+n[0]*a,e[1]*i+n[1]*a,e[2]*i+n[2]*a],s=Math.hypot(o[0],o[1],o[2])||1;return o[0]/=s,o[1]/=s,o[2]/=s,[o,[t[0],t[1],t[2]]]}var ze=`
${R}
${z}
...
`;function Ve(e,t){let n=new Map,r=new Map,i=new Map;for(let t of e.clusters)n.set(t.g,t.c),r.set(t.g,P(t.g)),i.set(t.g,[t.hue,t.sat]);let a=We(1319),o=e.particles,s=o.length,c=new Int32Array(s),l=He(s,(e,t)=>{let s=o[e],l=s[3],u=n.get(l)??[0,0,0],d=r.get(l)??[0,1,0],[f,p]=i.get(l)??[218,0];c[e]=l,t.pos=[s[0],s[1],s[2]],t.center=u,t.axis=d,t.period=F(t.pos,u),t.color=q(f,s[4]?Math.max(p,24):p),t.size=s[4]?1.9:1.35,t.seed=e*.618,t.start=Ue(a)}),u=e.solo,d=u.length,f=d>0?He(d,(e,t)=>{let n=u[e];t.pos=[n.p[0],n.p[1],n.p[2]],t.center=[n.p[0],n.p[1],n.p[2]],t.axis=[0,1,0],t.period=0,t.color=[.72,.8,1],t.size=2.2,t.seed=e*1.37+5,t.start=Ue(a)}):null,p={uT:{value:0},uConverge:{value:+!!t},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3}},m=new v({uniforms:{...p,uGain:{value:.3},uTwinkle:{value:0}},vertexShader:ze,fragmentShader:Be,blending:2,depthWrite:!1,depthTest:!1,transparent:!0}),h=new v({uniforms:{...p,uGain:{value:.85},uTwinkle:{value:t?0:.55}},vertexShader:ze,fragmentShader:Be,blending:2,depthWrite:!1,depthTest:!1,transparent:!0}),g=new S,_=new T(l.geo,m);_.renderOrder=6,_.frustumCulled=!1,g.add(_);let y=null;f&&(y=new T(f.geo,h),y.renderOrder=8,y.frustumCulled=!1,g.add(y));let b=[m,h];return{group:g,setUniform(e,t){for(let n of b)n.uniforms[e]&&(n.uniforms[e].value=t)},setMode(e,t,n){let r=t.wormholes[n];for(let t=0;t<s;t++)l.dim[t]=e===`all`?1:e===`worm`&&r?c[t]===r.a||c[t]===r.b?.9:.07:.12;if(l.dimAttr.needsUpdate=!0,f){let t=e===`solo`?1:e===`all`?.34:.08;f.dim.fill(t),f.dimAttr.needsUpdate=!0}},dispose(){l.geo.dispose(),f?.geo.dispose();for(let e of b)e.dispose()}}}function He(e,t){let n=new Float32Array(e*3),r=new Float32Array(e*3),i=new Float32Array(e*3),o=new Float32Array(e*3),c=new Float32Array(e*3),l=new Float32Array(e),u=new Float32Array(e),d=new Float32Array(e).fill(1),m=new Float32Array(e),h={pos:[0,0,0],start:[0,0,0],center:[0,0,0],axis:[0,1,0],color:[1,1,1],period:0,size:1,seed:0};for(let a=0;a<e;a++)t(a,h),n.set(h.pos,a*3),r.set(h.start,a*3),i[a*3]=h.center[0],i[a*3+1]=h.center[1],i[a*3+2]=h.center[2],o[a*3]=h.axis[0],o[a*3+1]=h.axis[1],o[a*3+2]=h.axis[2],c.set(h.color,a*3),l[a]=h.period,u[a]=h.size,m[a]=h.seed;let g=new a;return g.setAttribute(`position`,new s(n,3)),g.setAttribute(`aStart`,new s(r,3)),g.setAttribute(`aCenter`,new s(i,3)),g.setAttribute(`aAxis`,new s(o,3)),g.setAttribute(`aColor`,new s(c,3)),g.setAttribute(`aPeriod`,new s(l,1)),g.setAttribute(`aSize`,new s(u,1)),g.setAttribute(`aDim`,new s(d,1)),g.setAttribute(`aSeed`,new s(m,1)),g.boundingSphere=new p(new f,1e6),{geo:g,dim:d,dimAttr:g.getAttribute(`aDim`)}}function Ue(e){let t=e()*Math.PI*2,n=Math.acos(2*e()-1),r=2+e()*5;return[r*Math.sin(n)*Math.cos(t),r*Math.sin(n)*Math.sin(t),r*Math.cos(n)]}function We(e){let t=e>>>0;return()=>{t=t+1831565813>>>0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}var Ge=96,Ke=`
${z}
attribute vec3 aColor;
attribute float aDim;
uniform float uConverge;
...
`;function Je(e){let t=[],n=[],r=[];for(let i of e.clusters){let a=P(i.g),o=q(i.hue,i.sat),s=new Set;for(let t of i.mem){let n=e.stars.find(e=>e.c===t);if(!n)continue;let r=Math.hypot(n.p[0]-i.c[0],n.p[1]-i.c[1],n.p[2]-i.c[2]);r>1.5&&s.add(Math.round(r))}for(let e of s){let s=L(i.c,a,e,Ge);for(let e=0;e<s.length;e++){let a=s[e],c=s[(e+1)%s.length];t.push(a[0],a[1],a[2],c[0],c[1],c[2]),n.push(o[0],o[1],o[2],o[0],o[1],o[2]),r.push(i.g,i.g)}}}if(t.length===0)return null;let i=r.length,o=new a;o.setAttribute(`position`,new d(t,3)),o.setAttribute(`aColor`,new d(n,3));let c=new Float32Array(i).fill(1);o.setAttribute(`aDim`,new s(c,1)),o.computeBoundingSphere();let l=new v({uniforms:{uConverge:{value:0},uNear:{value:1},uFar:{value:4e3},uGain:{value:.24}},vertexShader:Ke,fragmentShader:qe,blending:2,depthWrite:!1,depthTest:!1,transparent:!0}),u=new C(o,l);u.renderOrder=4,u.frustumCulled=!1;let f=r,p=o.getAttribute(`aDim`);return{object:u,setUniform(e,t){l.uniforms[e]&&(l.uniforms[e].value=t)},setMode(e,t,n){let r=t.wormholes[n];for(let t=0;t<i;t++)c[t]=e===`all`?1:e===`worm`&&r?+(f[t]===r.a||f[t]===r.b):.14;p.needsUpdate=!0},dispose(){o.dispose(),l.dispose()}}}var Ye=new m(1,.62,.24),Xe=190,Ze=`
${z}
