...
`,M=class e{cleanups=[];closed=!1;defer(e){let t=!0,n=()=>{t&&(t=!1,e())};return this.closed?(n(),n):(this.cleanups.push(n),n)}use(e){return this.defer(()=>e.dispose()),e}release(){if(this.closed)return()=>void 0;this.closed=!0;let e=this.cleanups;this.cleanups=[];let t=!1;return()=>{if(!t){t=!0;for(let t=e.length-1;t>=0;t--)e[t]()}}}dispose(){this.release()()}static construct(t){let n=new e;try{return t(n)}catch(e){throw n.dispose(),e}}},oe=class{ready=!1;failed=!1;destroyed=!1;onReady;onError;constructor(e,t){this.onReady=e,this.onError=t}frameSucceeded(){return this.destroyed||this.ready||this.failed?!1:(this.ready=!0,this.onReady?.(),!0)}frameFailed(e){this.destroyed||this.failed||(this.failed=!0,this.onError?.(e instanceof Error?e:Error(String(e))))}destroy(){this.destroyed=!0}},N=6400,P=1.92;function F(e,t){let n=Math.max(0,t);return e<125?-Math.min(1,n/68):Math.min(1,n/62)}function se(e,t){return N*P**+F(e,t)}function ce(e){let t=R(e,1e3,4e4)/100,n=t<=66?255:329.698727446*(t-60)**-.1332047592,r=t<=66?99.4708025861*Math.log(t)-161.1195681661:288.1221695283*(t-60)**-.0755148492,i=t>=66?255:t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307,a=[L(R(n,0,255)/255),L(R(r,0,255)/255),L(R(i,0,255)/255)],o=Math.max(a[0],a[1],a[2])||1;return[a[0]/o,a[1]/o,a[2]/o]}function I(e,t){return ce(se(e,t))}function L(e){return e<=.04045?e/12.92:((e+.055)/1.055)**2.4}function R(e,t,n){return e<t?t:e>n?n:e}var z=2.25;function le(e){return e?.38:1}function ue(e){let t=0;for(let n of e.stars)t=Math.max(t,Math.hypot(n.p[0],n.p[1],n.p[2]));for(let n of e.clusters)t=Math.max(t,Math.hypot(n.c[0],n.c[1],n.c[2]));return Math.max(60,t)}function de(e){let t=[...e.clusters].sort((e,t)=>t.n-e.n).slice(0,3),n=e=>{let n=t[e]??t[0];if(!n)return new S(.6,.7,1);let[r,i,a]=I(n.hue,n.sat);return new S(r,i,a)},r=n(2).clone().lerp(new S(1,1,1),.62);return[new S(.12,.19,.66).lerp(n(0),.26),new S(.54,.16,.6).lerp(n(1),.3),new S(.04,.42,.48).lerp(r,.26)]}var B=[{r:1,freq:3.4,warp:1.1,low:.1,high:.62,flat:1.45,dust:.55,spin:.0042},{r:1.62,freq:2.3,warp:.85,low:.16,high:.7,flat:1.05,dust:.38,spin:.0026},{r:2.45,freq:1.5,warp:.55,low:.24,high:.8,flat:.72,dust:.2,spin:.0015}];function V(e,t,n,r){return M.construct(i=>fe(e,t,n,r,i))}function fe(e,t,n,r,i){let o=new y,s=[],c=[];B.forEach((l,u)=>{let d=i.use(pe(e,r.nebulaBake,{freq:l.freq,warp:l.warp,low:l.low,high:l.high,flat:l.flat,dust:l.dust,seed:3.7+u*17.3,colA:n[0],colB:n[1],colC:n[2]})),f=r.shellGain[u],p=i.use(new a({uniforms:{uMap:{value:d.texture},uGain:{value:f}},vertexShader:`
    ...
    `,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),s=new w(r.use(new o(e*z,e*z)),i);return s.renderOrder=-5,s.frustumCulled=!1,s}function pe(e,n,r){let o=new C(n,{type:h,format:t,generateMipmaps:!1,minFilter:d,magFilter:d}),s=new M;try{let t=s.use(new a({uniforms:{uFreq:{value:r.freq},uWarp:{value:r.warp},uLow:{value:r.low},uHigh:{value:r.high},uFlat:{value:r.flat},uDust:{value:r.dust},uSeed:{value:r.seed},uColA:{value:r.colA.clone()},uColB:{value:r.colB.clone()},uColC:{value:r.colC.clone()}},vertexShader:`
      varying vec3 vDir;
      void main() {
        vDir = position;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
void main() {
  ...
  vAlpha = iBasisDim.w * lod * smoothstep(${Oe.toFixed(2)}, 1.0, uConverge)
