import{c as e}from"./api-vGgttR-j.js";import{A as t,B as n,C as r,D as i,E as a,M as o,N as s,O as c,P as l,_ as u,a as d,c as f,f as p,g as m,h,i as g,j as _,k as v,m as y,n as b,o as x,s as S,t as C,v as w,y as T}from"./three-Cq-fTrNH.js";import{a as E,i as D,n as ee,o as O,r as k,s as te,t as A}from"./postprocessing-UefeKVF2.js";var j=`
...
`,F=class e{cleanups=[];closed=!1;defer(e){let t=!0,n=()=>{t&&(t=!1,e())};return this.closed?(n(),n):(this.cleanups.push(n),n)}use(e){return this.defer(()=>e.dispose()),e}release(){if(this.closed)return()=>void 0;this.closed=!0;let e=this.cleanups;this.cleanups=[];let t=!1;return()=>{if(!t){t=!0;for(let t=e.length-1;t>=0;t--)e[t]()}}}dispose(){this.release()()}static construct(t){let n=new e;try{return t(n)}catch(e){throw n.dispose(),e}}},ne=class{ready=!1;failed=!1;destroyed=!1;onReady;onError;constructor(e,t){this.onReady=e,this.onError=t}frameSucceeded(){return this.destroyed||this.ready||this.failed?!1:(this.ready=!0,this.onReady?.(),!0)}frameFailed(e){this.destroyed||this.failed||(this.failed=!0,this.onError?.(e instanceof Error?e:Error(String(e))))}destroy(){this.destroyed=!0}},re=6400,ie=1.92;function I(e,t){let n=Math.max(0,t);return e<125?-Math.min(1,n/68):Math.min(1,n/62)}function L(e,t){return re*ie**+I(e,t)}function R(e){let t=V(e,1e3,4e4)/100,n=t<=66?255:329.698727446*(t-60)**-.1332047592,r=t<=66?99.4708025861*Math.log(t)-161.1195681661:288.1221695283*(t-60)**-.0755148492,i=t>=66?255:t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307,a=[B(V(n,0,255)/255),B(V(r,0,255)/255),B(V(i,0,255)/255)],o=Math.max(a[0],a[1],a[2])||1;return[a[0]/o,a[1]/o,a[2]/o]}function z(e,t){return R(L(e,t))}function B(e){return e<=.04045?e/12.92:((e+.055)/1.055)**2.4}function V(e,t,n){return e<t?t:e>n?n:e}var ae=2.25;function H(e){return e?.38:1}function U(e){let t=0;for(let n of e.stars)t=Math.max(t,Math.hypot(n.p[0],n.p[1],n.p[2]));for(let n of e.clusters)t=Math.max(t,Math.hypot(n.c[0],n.c[1],n.c[2]));return Math.max(60,t)}function oe(e){let t=[...e.clusters].sort((e,t)=>t.n-e.n).slice(0,3),n=e=>{let n=t[e]??t[0];if(!n)return new S(.6,.7,1);let[r,i,a]=z(n.hue,n.sat);return new S(r,i,a)},r=n(2).clone().lerp(new S(1,1,1),.62);return[new S(.12,.19,.66).lerp(n(0),.26),new S(.54,.16,.6).lerp(n(1),.3),new S(.04,.42,.48).lerp(r,.26)]}var W=[{r:1,freq:3.4,warp:1.1,low:.1,high:.62,flat:1.45,dust:.55,spin:.0042},{r:1.62,freq:2.3,warp:.85,low:.16,high:.7,flat:1.05,dust:.38,spin:.0026},{r:2.45,freq:1.5,warp:.55,low:.24,high:.8,flat:.72,dust:.2,spin:.0015}];function se(e,t,n,r){return F.construct(i=>G(e,t,n,r,i))}function G(e,t,n,i,a){let s=new y,c=[],l=[];W.forEach((u,d)=>{let f=a.use(K(e,i.nebulaBake,{freq:u.freq,warp:u.warp,low:u.low,high:u.high,flat:u.flat,dust:u.dust,seed:3.7+d*17.3,colA:n[0],colB:n[1],colC:n[2]})),p=i.shellGain[d],m=a.use(new o({uniforms:{uMap:{value:f.texture},uGain:{value:p}},vertexShader:`
        varying vec3 vDir;
        void main() {
          vDir = position;
      ...
      `,side:1,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),h=a.use(new g(1,1,1)),_=new r(h,m);_.scale.setScalar(t*u.r*22),_.renderOrder=-40+d,_.frustumCulled=!1,_.rotation.set(d*1.31,d*2.17,d*.73),s.add(_),c.push({mesh:_,spin:u.spin}),l.push({u:m.uniforms.uGain,base:p})});let u=ce(t,n[1],i.coreGain,a);return s.add(u),l.push({u:u.material.uniforms.uGain,base:i.coreGain}),{group:s,update(e,t){c.forEach((t,n)=>{t.mesh.rotation.set(n*1.31,n*2.17+e*t.spin,n*.73)}),u.quaternion.copy(t.quaternion)},setDim(e){for(let t of l)t.u.value=t.base*e},dispose:a.release()}}function ce(e,t,n,a){let s=a.use(new o({uniforms:{uTint:{value:t.clone()},uGain:{value:n}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),c=new r(a.use(new i(e*ae,e*ae)),s);return c.renderOrder=-5,c.frustumCulled=!1,c}function K(e,t,n){let i=new C(t,{type:h,format:v,generateMipmaps:!1,minFilter:T,magFilter:T}),a=new F;try{let t=a.use(new o({uniforms:{uFreq:{value:n.freq},uWarp:{value:n.warp},uLow:{value:n.low},uHigh:{value:n.high},uFlat:{value:n.flat},uDust:{value:n.dust},uSeed:{value:n.seed},uColA:{value:n.colA.clone()},uColB:{value:n.colB.clone()},uColC:{value:n.colC.clone()}},vertexShader:`
      varying vec3 vDir;
      void main() {
        vDir = position;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function We(t,i){let a=t.universe,c=fe(a),f=c.length,p=new l(1,32,20),h=new u;h.index=p.index,h.setAttribute(`position`,p.getAttribute(`position`)),h.instanceCount=f;let g=new Float32Array(f*3),_=new Float32Array(f*3),v=new Float32Array(f*3),b=new Float32Array(f*3),x=new Float32Array(f*3),S=new Float32Array(f*4),C=new Float32Array(f*2);c.forEach((e,t)=>{g.set(e.p,t*3),_.set(e.center,t*3),v.set(e.axis,t*3),b.set(e.start,t*3),x.set(e.color,t*3),S.set([e.period,e.ignite,e.bodyR,e.seed],t*4),C.set([e.kelvin,1],t*2)}),h.setAttribute(`iPos`,new m(g,3)),h.setAttribute(`iCenter`,new m(_,3)),h.setAttribute(`iAxis`,new m(v,3)),h.setAttribute(`iStart`,new m(b,3)),h.setAttribute(`iColor`,new m(x,3)),h.setAttribute(`iOrb`,new m(S,4)),h.setAttribute(`iMeta`,new m(C,2)),h.boundingSphere=new s(new n,1e6);let T=()=>({uT:{value:0},uConverge:{value:+!!i},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3},uBob:{value:i?0:1.35}}),E=new o({uniforms:{...T(),uIgniteMs:{value:700},uLitFloor:{value:+!!i},uGain:{value:Le.star}},vertexShader:Re,fragmentShader:ze,transparent:!0,depthTest:!0,depthWrite:!0}),D=new r(h,E);D.renderOrder=9,D.frustumCulled=!1;let ee=c.map(n=>e(t,n.s)),O=1/0,k=-1/0;for(let e of ee)for(let t of e){let e=t.latestPublicAt;e!==void 0&&(e<O&&(O=e),e>k&&(k=e))}let te=Math.max(1,k-O),A=e=>e===void 0||!Number.isFinite(O)||!Number.isFinite(k)?.45:Math.min(.999,Math.max(0,(e-O)/te)),j=[];c.forEach((e,t)=>ee[t].forEach((t,n)=>j.push({d:e,idx:n,datum:t,own:+!!t.created,fresh:A(t.latestPublicAt)})));let M=j.length,N=new Float32Array(M*3),P=new Float32Array(M*3),F=new Float32Array(M*3),ne=new Float32Array(M*3),re=new Float32Array(M*3),ie=new Float32Array(M*3),I=new Float32Array(M*4),L=new Float32Array(M*4),R=new Float32Array(M).fill(1),z=new Float32Array(M),B=new Int32Array(M),V=[],ae=new Map;c.forEach((e,t)=>ae.set(e,t)),j.forEach((e,t)=>{let n=e.d,r=e.idx*2654435761%1e3/1e3-.5,[i,a]=Ke(n.sysU,n.sysV,n.sysAxis,r*.22),o=Pe+e.idx*Fe,s=7+2.4*o**1.5,c=(e.idx*137.508+n.seed*31.7)*Math.PI/180,l=Ie+.115*Math.min(1,Math.log1p(e.datum.answerCount)/Math.log1p(30));N.set(i,t*3),P.set(a,t*3),F.set(n.p,t*3),ne.set(n.center,t*3),re.set(n.axis,t*3),ie.set(n.color,t*3),I.set([o,c,s,l],t*4),L.set([e.own*2+e.fresh,n.seed,n.bodyR,n.period],t*4),B[t]=ae.get(n),V.push({star:n,question:e.datum.question,answerCount:e.datum.answerCount,created:e.datum.created,collected:e.datum.collected,latestPublicAt:e.datum.latestPublicAt,answers:e.datum.answers,orbitIndex:e.datum.orbitIndex,index:t,u:i,v:a,orbitR:o,phase:c,period:s,radius:l})});let H=new l(1,20,14),U=new u;U.index=H.index,U.setAttribute(`position`,H.getAttribute(`position`)),U.instanceCount=M,Ge(U,{pU:N,pV:P,pStarPos:F,pStarCenter:ne,pStarAxis:re,pColor:ie,pOrb:I,pMeta:L,pDim:R,pSel:z});let oe=new o({uniforms:{...T(),uGain:{value:Le.planet}},vertexShader:Be,fragmentShader:Ve,transparent:!0,depthTest:!0,depthWrite:!0}),W=new r(U,oe);W.renderOrder=9,W.frustumCulled=!1;let se=new Float32Array(432);for(let e=0;e<72;e++){let t=e/72*Math.PI*2,n=(e+1)/72*Math.PI*2;se.set([Math.cos(t),Math.sin(t),0,Math.cos(n),Math.sin(n),0],e*6)}let G=new u;G.setAttribute(`position`,new d(se,3)),G.instanceCount=M,Ge(G,{pU:N,pV:P,pStarPos:F,pStarCenter:ne,pStarAxis:re,pColor:ie,pOrb:I,pMeta:L,pDim:R,pSel:z});let ce=new o({uniforms:{...T(),uGain:{value:Le.ring}},vertexShader:He,fragmentShader:Ue,transparent:!0,blending:2,depthTest:!1,depthWrite:!1}),K=new w(G,ce);K.renderOrder=8.5,K.frustumCulled=!1;let q=new y;q.add(K,D,W);let J=[E,oe,ce],le=h.getAttribute(`iMeta`),ue=U.getAttribute(`iDim`),de=G.getAttribute(`iDim`),pe=U.getAttribute(`iSel`),me=G.getAttribute(`iSel`),Y=-1,he=Ae(V),X=c.map(()=>1),Z=null,ge=()=>{for(let e=0;e<f;e++)C[e*2+1]=X[e]*Q(c[e].s.c,Z);for(let e=0;e<M;e++)R[e]=X[B[e]]*Q(V[e].star.s.c,Z);le.needsUpdate=!0,ue.needsUpdate=!0,de.needsUpdate=!0};return{group:q,data:c,planets:V,planetsForStar:e=>he.get(e)??[],setSelected(e){e!==Y&&(Y>=0&&(z[Y]=0),Y=e>=0&&e<M?e:-1,Y>=0&&(z[Y]=1),pe.needsUpdate=!0,me.needsUpdate=!0)},setUniform(e,t){for(let n of J)n.uniforms[e]&&(n.uniforms[e].value=t)},setFocus(e){Z=e,ge()},setMode(e,t,n){X=c.map(r=>we(r.s,e,t,n)),ge()},dispose(){p.dispose(),H.dispose(),h.dispose(),U.dispose(),G.dispose();for(let e of J)e.dispose()}}}function Ge(e,t){e.setAttribute(`iU`,new m(t.pU,3)),e.setAttribute(`iV`,new m(t.pV,3)),e.setAttribute(`iStarPos`,new m(t.pStarPos,3)),e.setAttribute(`iStarCenter`,new m(t.pStarCenter,3)),e.setAttribute(`iStarAxis`,new m(t.pStarAxis,3)),e.setAttribute(`iColor`,new m(t.pColor,3)),e.setAttribute(`iOrb`,new m(t.pOrb,4)),e.setAttribute(`iMeta`,new m(t.pMeta,4)),e.setAttribute(`iDim`,new m(t.pDim,1)),e.setAttribute(`iSel`,new m(t.pSel,1)),e.boundingSphere=new s(new n,1e6)}function Ke(e,t,n,r){let i=Math.cos(r),a=Math.sin(r),o=[e[0]*i+n[0]*a,e[1]*i+n[1]*a,e[2]*i+n[2]*a],s=Math.hypot(o[0],o[1],o[2])||1;return o[0]/=s,o[1]/=s,o[2]/=s,[o,[t[0],t[1],t[2]]]}var qe=`
${j}
${M}
