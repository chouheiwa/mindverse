import{c as e}from"./api-vGgttR-j.js";import{A as t,D as n,F as r,M as i,N as a,O as o,P as s,V as c,_ as l,a as u,b as d,c as f,f as p,g as m,h,i as g,j as _,k as v,m as y,n as b,o as x,s as S,t as C,v as ee,w,y as T}from"./three-B4KVT46k.js";import{a as E,i as te,n as D,o as ne,r as O,s as k,t as A}from"./postprocessing-BJ29hrYV.js";var j=`
...
`,P=class e{cleanups=[];closed=!1;defer(e){let t=!0,n=()=>{t&&(t=!1,e())};return this.closed?(n(),n):(this.cleanups.push(n),n)}use(e){return this.defer(()=>e.dispose()),e}release(){if(this.closed)return()=>void 0;this.closed=!0;let e=this.cleanups;this.cleanups=[];let t=!1;return()=>{if(!t){t=!0;for(let t=e.length-1;t>=0;t--)e[t]()}}}dispose(){this.release()()}static construct(t){let n=new e;try{return t(n)}catch(e){throw n.dispose(),e}}},ie=class{ready=!1;failed=!1;destroyed=!1;onReady;onError;constructor(e,t){this.onReady=e,this.onError=t}frameSucceeded(){return this.destroyed||this.ready||this.failed?!1:(this.ready=!0,this.onReady?.(),!0)}frameFailed(e){this.destroyed||this.failed||(this.failed=!0,this.onError?.(e instanceof Error?e:Error(String(e))))}destroy(){this.destroyed=!0}},F=6400,ae=1.92;function oe(e,t){let n=Math.max(0,t);return e<125?-Math.min(1,n/68):Math.min(1,n/62)}function se(e,t){return F*ae**+oe(e,t)}function ce(e){let t=R(e,1e3,4e4)/100,n=t<=66?255:329.698727446*(t-60)**-.1332047592,r=t<=66?99.4708025861*Math.log(t)-161.1195681661:288.1221695283*(t-60)**-.0755148492,i=t>=66?255:t<=19?0:138.5177312231*Math.log(t-10)-305.0447927307,a=[L(R(n,0,255)/255),L(R(r,0,255)/255),L(R(i,0,255)/255)],o=Math.max(a[0],a[1],a[2])||1;return[a[0]/o,a[1]/o,a[2]/o]}function I(e,t){return ce(se(e,t))}function L(e){return e<=.04045?e/12.92:((e+.055)/1.055)**2.4}function R(e,t,n){return e<t?t:e>n?n:e}var z=2.25;function le(e){return e?.38:1}function ue(e){let t=0;for(let n of e.stars)t=Math.max(t,Math.hypot(n.p[0],n.p[1],n.p[2]));for(let n of e.clusters)t=Math.max(t,Math.hypot(n.c[0],n.c[1],n.c[2]));return Math.max(60,t)}function de(e){let t=[...e.clusters].sort((e,t)=>t.n-e.n).slice(0,3),n=e=>{let n=t[e]??t[0];if(!n)return new S(.6,.7,1);let[r,i,a]=I(n.hue,n.sat);return new S(r,i,a)},r=n(2).clone().lerp(new S(1,1,1),.62);return[new S(.12,.19,.66).lerp(n(0),.26),new S(.54,.16,.6).lerp(n(1),.3),new S(.04,.42,.48).lerp(r,.26)]}var B=[{r:1,freq:3.4,warp:1.1,low:.1,high:.62,flat:1.45,dust:.55,spin:.0042},{r:1.62,freq:2.3,warp:.85,low:.16,high:.7,flat:1.05,dust:.38,spin:.0026},{r:2.45,freq:1.5,warp:.55,low:.24,high:.8,flat:.72,dust:.2,spin:.0015}];function V(e,t,n,r){return P.construct(i=>fe(e,t,n,r,i))}function fe(e,t,n,r,i){let o=new y,s=[],c=[];B.forEach((l,u)=>{let d=i.use(pe(e,r.nebulaBake,{freq:l.freq,warp:l.warp,low:l.low,high:l.high,flat:l.flat,dust:l.dust,seed:3.7+u*17.3,colA:n[0],colB:n[1],colC:n[2]})),f=r.shellGain[u],p=i.use(new a({uniforms:{uMap:{value:d.texture},uGain:{value:f}},vertexShader:`
        varying vec3 vDir;
        void main() {
          vDir = position;
      ...
      `,side:1,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),m=i.use(new g(1,1,1)),h=new w(m,p);h.scale.setScalar(t*l.r*22),h.renderOrder=-40+u,h.frustumCulled=!1,h.rotation.set(u*1.31,u*2.17,u*.73),o.add(h),s.push({mesh:h,spin:l.spin}),c.push({u:p.uniforms.uGain,base:f})});let l=H(t,n[1],r.coreGain,i);return o.add(l),c.push({u:l.material.uniforms.uGain,base:r.coreGain}),{group:o,update(e,t){s.forEach((t,n)=>{t.mesh.rotation.set(n*1.31,n*2.17+e*t.spin,n*.73)}),l.quaternion.copy(t.quaternion)},setDim(e){for(let t of c)t.u.value=t.base*e},dispose:i.release()}}function H(e,t,n,r){let i=r.use(new a({uniforms:{uTint:{value:t.clone()},uGain:{value:n}},vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
    ...
    `,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),s=new w(r.use(new o(e*z,e*z)),i);return s.renderOrder=-5,s.frustumCulled=!1,s}function pe(e,n,r){let o=new C(n,{type:h,format:t,generateMipmaps:!1,minFilter:d,magFilter:d}),s=new P;try{let t=s.use(new a({uniforms:{uFreq:{value:r.freq},uWarp:{value:r.warp},uLow:{value:r.low},uHigh:{value:r.high},uFlat:{value:r.flat},uDust:{value:r.dust},uSeed:{value:r.seed},uColA:{value:r.colA.clone()},uColB:{value:r.colB.clone()},uColC:{value:r.colC.clone()}},vertexShader:`
      varying vec3 vDir;
      void main() {
        vDir = position;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
...
`;function at(e,t){return P.construct(n=>ot(e,t,n))}function ot(t,n,i){let o=t.universe,d=_e(o),f=d.length,p=i.use(new r(1,32,20)),h=i.use(new l);h.index=p.index,h.setAttribute(`position`,p.getAttribute(`position`)),h.instanceCount=f;let g=new Float32Array(f*3),_=new Float32Array(f*3),v=new Float32Array(f*3),b=new Float32Array(f*3),x=new Float32Array(f*3),S=new Float32Array(f*4),C=new Float32Array(f*2);d.forEach((e,t)=>{g.set(e.p,t*3),_.set(e.center,t*3),v.set(e.axis,t*3),b.set(e.start,t*3),x.set(e.color,t*3),S.set([e.period,e.ignite,e.bodyR,e.seed],t*4),C.set([e.kelvin,1],t*2)}),h.setAttribute(`iPos`,new m(g,3)),h.setAttribute(`iCenter`,new m(_,3)),h.setAttribute(`iAxis`,new m(v,3)),h.setAttribute(`iStart`,new m(b,3)),h.setAttribute(`iColor`,new m(x,3)),h.setAttribute(`iOrb`,new m(S,4)),h.setAttribute(`iMeta`,new m(C,2)),h.boundingSphere=new s(new c,1e6);let E=()=>({uT:{value:0},uConverge:{value:+!!n},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3},uBob:{value:n?0:1.35}}),te=i.use(new a({uniforms:{...E(),uIgniteMs:{value:700},uLitFloor:{value:+!!n},uGain:{value:Ze.star}},vertexShader:Qe,fragmentShader:$e,transparent:!0,depthTest:!0,depthWrite:!0})),D=new w(h,te);D.renderOrder=9,D.frustumCulled=!1;let ne=d.map(n=>e(t,n.s)),O=Ke([...t.answersById.values()]),k=[];d.forEach((e,t)=>ne[t].forEach((t,n)=>k.push({d:e,idx:n,datum:t,material:qe(t,O)})));let A=k.length,j=new Float32Array(A*3),M=new Float32Array(A*3),N=new Float32Array(A*3),re=new Float32Array(A*3),P=new Float32Array(A*3),ie=new Float32Array(A*3),F=new Float32Array(A*3),ae=new Float32Array(A*4),oe=new Float32Array(A*4),se=new Float32Array(A*4),ce=new Float32Array(A*4),I=new Float32Array(A).fill(1),L=new Float32Array(A),R=new Int32Array(A),z=[],le=new Map;d.forEach((e,t)=>le.set(e,t)),k.forEach((e,t)=>{let n=e.d,r=e.idx*2654435761%1e3/1e3-.5,[i,a]=ut(n.sysU,n.sysV,n.sysAxis,r*.22),o=Je+e.idx*Ye,s=7+2.4*o**1.5,c=(e.idx*137.508+n.seed*31.7)*Math.PI/180,l=Xe+.115*e.material.answerDensity;j.set(i,t*3),M.set(a,t*3),N.set(n.p,t*3),re.set(n.center,t*3),P.set(n.axis,t*3),ie.set(n.sysAxis,t*3),F.set(n.color,t*3),ae.set([o,c,s,l],t*4),oe.set([(e.material.created?2:0)+e.material.freshness,n.seed,n.bodyR,n.period],t*4),se.set([e.material.seed,e.material.answerDensity,e.material.freshness,ze(e.material.family)],t*4),ce.set([e.material.timeSpan??0,e.material.timeSpan===null?0:1,+!!e.material.created,+!!e.material.collected],t*4),R[t]=le.get(n),z.push({star:n,question:e.datum.question,answerCount:e.datum.answerCount,created:e.datum.created,collected:e.datum.collected,latestPublicAt:e.datum.latestPublicAt,answers:e.datum.answers,material:e.material,orbitIndex:e.datum.orbitIndex,index:t,u:i,v:a,orbitR:o,phase:c,period:s,radius:l})});let ue=i.use(new r(1,20,14)),de=Be(k.map(({material:e})=>e)),B=Ve(de,A),V=de.map(e=>{let t=e.globalIndices.length,r=lt(e.globalIndices,{pU:j,pV:M,pStarPos:N,pStarCenter:re,pStarAxis:P,pSystemAxis:ie,pColor:F,pOrb:ae,pMeta:oe,pSurface:se,pChronicle:ce,pDim:I,pSel:L}),o=i.use(new l);o.index=ue.index,o.setAttribute(`position`,ue.getAttribute(`position`)),o.instanceCount=t,st(o,r),o.setAttribute(`normal`,new m(r.pSystemAxis,3)),o.setAttribute(`iSurface`,new m(r.pSurface,4)),o.setAttribute(`iChronicle`,new m(r.pChronicle,4));let s=new Float32Array(t*4),c=new Float32Array(t*4),u=new Float32Array(t*4);for(let e=0;e<t;e++)s.set(r.pU.subarray(e*3,e*3+3),e*4),s[e*4+3]=r.pDim[e],c.set(r.pColor.subarray(e*3,e*3+3),e*4),c[e*4+3]=r.pSel[e],u.set(r.pStarAxis.subarray(e*3,e*3+3),e*4);o.setAttribute(`iBasisDim`,new m(s,4)),o.setAttribute(`iColorSelected`,new m(c,4)),o.setAttribute(`iAxisLod`,new m(u,4));let d=ze(e.family),f=i.use(new a({uniforms:{...E(),uGain:{value:Ze.planet},uMotion:{value:+!n}},vertexShader:et,fragmentShader:nt(d),transparent:!0,depthTest:!0,depthWrite:!0})),p=i.use(new ee(o,f,t));return p.userData.planetFamily=e.family,p.renderOrder=9,p.frustumCulled=!1,{family:e.family,globalIndices:e.globalIndices,geometry:o,material:f,mesh:p,basisDim:s,colorSelected:c,axisLod:u,basisDimAttribute:o.getAttribute(`iBasisDim`),colorSelectedAttribute:o.getAttribute(`iColorSelected`),axisLodAttribute:o.getAttribute(`iAxisLod`)}}),fe=new Float32Array(432);for(let e=0;e<72;e++){let t=e/72*Math.PI*2,n=(e+1)/72*Math.PI*2;fe.set([Math.cos(t),Math.sin(t),0,Math.cos(n),Math.sin(n),0],e*6)}let H=i.use(new l);H.setAttribute(`position`,new u(fe,3)),H.instanceCount=A,ct(H,{pU:j,pV:M,pStarPos:N,pStarCenter:re,pStarAxis:P,pColor:F,pOrb:ae,pMeta:oe,pDim:I,pSel:L});let pe=i.use(new a({uniforms:{...E(),uGain:{value:Ze.ring}},vertexShader:rt,fragmentShader:it,transparent:!0,blending:2,depthTest:!1,depthWrite:!1})),U=new T(H,pe);U.renderOrder=8.5,U.frustumCulled=!1;let W=new y;W.add(U,D,...V.map(({mesh:e})=>e));let me=[te,pe,...V.map(({material:e})=>e)],he=h.getAttribute(`iMeta`),ve=H.getAttribute(`iDim`),ye=H.getAttribute(`iSel`),G=-1,be=Me(z),K=z.map(()=>`far`),q=Object.freeze([]),J=q,Y=new c,xe=new c,Se=new Map(V.map(e=>[e.family,e])),Ce=d.map(()=>1),we=null,X=null,Te=i.release(),De=()=>{for(let e=0;e<f;e++)C[e*2+1]=Ce[e]*Z(d[e].s.c,we);for(let e=0;e<A;e++)I[e]=Ce[R[e]]*Z(z[e].star.s.c,we);for(let e of V)e.globalIndices.forEach((t,n)=>{e.basisDim[n*4+3]=I[t]}),e.basisDimAttribute.needsUpdate=!0;he.needsUpdate=!0,ve.needsUpdate=!0};return{group:W,data:d,planets:z,planetIndexMap:B,planetsForStar:e=>be.get(e)??[],setSelected(e){if(e!==G){if(G>=0){L[G]=0;let e=B.toLocal(G);if(e){let t=V.find(({family:t})=>t===e.family);t.colorSelected[e.instanceIndex*4+3]=0,t.colorSelectedAttribute.needsUpdate=!0}}if(G=e>=0&&e<A?e:-1,G>=0){L[G]=1;let e=B.toLocal(G),t=V.find(({family:t})=>t===e.family);t.colorSelected[e.instanceIndex*4+3]=1,t.colorSelectedAttribute.needsUpdate=!0}ye.needsUpdate=!0}},updatePlanetLods(e,t,r){let i=X===null?q:be.get(X)??q,a=new Set,o=(e,t)=>{if(K[e.index]===t)return;K[e.index]=t;let n=B.toLocal(e.index),r=Se.get(n.family);r.axisLod[n.instanceIndex*4+3]=t===`far`?0:t===`medium`?1:2,a.add(r)};if(i!==J){for(let e of J)o(e,`far`);J=i}e.updateMatrixWorld();let s=n?0:1.35;for(let n of J){ge(n.star,t,s,Y);let i=n.phase+Math.PI*2/n.period*(t/1e3),a=Math.cos(i),c=Math.sin(i);Y.set(Y.x+(n.u[0]*a+n.v[0]*c)*n.orbitR,Y.y+(n.u[1]*a+n.v[1]*c)*n.orbitR,Y.z+(n.u[2]*a+n.v[2]*c)*n.orbitR),xe.copy(Y).applyMatrix4(e.matrixWorldInverse);let l=n.radius*r/Math.max(1,-xe.z);o(n,He(K[n.index],l))}for(let e of a)e.axisLodAttribute.needsUpdate=!0},setUniform(e,t){for(let n of me)n.uniforms[e]&&(n.uniforms[e].value=t)},setFocus(e){X=e===null?null:d.find(t=>(`id`in t.s?t.s.id:t.s.c)===e)??null,we=X?.s.c??null,De()},setMode(e,t,n){Ce=d.map(r=>Ee(r.s,e,t,n)),De()},dispose:Te}}function st(e,t){e.setAttribute(`iStarPos`,new m(t.pStarPos,3)),e.setAttribute(`iStarCenter`,new m(t.pStarCenter,3)),e.setAttribute(`iOrb`,new m(t.pOrb,4)),e.setAttribute(`iMeta`,new m(t.pMeta,4)),e.boundingSphere=new s(new c,1e6)}function ct(e,t){e.setAttribute(`iU`,new m(t.pU,3)),e.setAttribute(`iV`,new m(t.pV,3)),e.setAttribute(`iStarPos`,new m(t.pStarPos,3)),e.setAttribute(`iStarCenter`,new m(t.pStarCenter,3)),e.setAttribute(`iStarAxis`,new m(t.pStarAxis,3)),e.setAttribute(`iColor`,new m(t.pColor,3)),e.setAttribute(`iOrb`,new m(t.pOrb,4)),e.setAttribute(`iMeta`,new m(t.pMeta,4)),e.setAttribute(`iDim`,new m(t.pDim,1)),e.setAttribute(`iSel`,new m(t.pSel,1)),e.boundingSphere=new s(new c,1e6)}function lt(e,t){let n={pU:new Float32Array(e.length*3),pV:new Float32Array(e.length*3),pStarPos:new Float32Array(e.length*3),pStarCenter:new Float32Array(e.length*3),pStarAxis:new Float32Array(e.length*3),pSystemAxis:new Float32Array(e.length*3),pColor:new Float32Array(e.length*3),pOrb:new Float32Array(e.length*4),pMeta:new Float32Array(e.length*4),pSurface:new Float32Array(e.length*4),pChronicle:new Float32Array(e.length*4),pDim:new Float32Array(e.length),pSel:new Float32Array(e.length)},r=(e,t,n,r,i)=>{e.set(t.subarray(r*n,r*n+n),i*n)};return e.forEach((e,i)=>{r(n.pU,t.pU,3,e,i),r(n.pV,t.pV,3,e,i),r(n.pStarPos,t.pStarPos,3,e,i),r(n.pStarCenter,t.pStarCenter,3,e,i),r(n.pStarAxis,t.pStarAxis,3,e,i),r(n.pSystemAxis,t.pSystemAxis,3,e,i),r(n.pColor,t.pColor,3,e,i),r(n.pOrb,t.pOrb,4,e,i),r(n.pMeta,t.pMeta,4,e,i),r(n.pSurface,t.pSurface,4,e,i),r(n.pChronicle,t.pChronicle,4,e,i),n.pDim[i]=t.pDim[e],n.pSel[i]=t.pSel[e]}),n}function ut(e,t,n,r){let i=Math.cos(r),a=Math.sin(r),o=[e[0]*i+n[0]*a,e[1]*i+n[1]*a,e[2]*i+n[2]*a],s=Math.hypot(o[0],o[1],o[2])||1;return o[0]/=s,o[1]/=s,o[2]/=s,[o,[t[0],t[1],t[2]]]}var dt=`
${j}
${M}
...
`;function xt(e){return P.construct(t=>St(e,t))}function St(e,t){let n=[],r=[],i=[];for(let t of e.clusters){let a=U(t.g),o=I(t.hue,t.sat),s=new Set;for(let n of t.mem){let r=e.stars.find(e=>e.c===n);if(!r)continue;let i=Math.hypot(r.p[0]-t.c[0],r.p[1]-t.c[1],r.p[2]-t.c[2]);i>1.5&&s.add(Math.round(i))}for(let e of s){let s=me(t.c,a,e,vt);for(let e=0;e<s.length;e++){let a=s[e],c=s[(e+1)%s.length];n.push(a[0],a[1],a[2],c[0],c[1],c[2]),r.push(o[0],o[1],o[2],o[0],o[1],o[2]),i.push(t.g,t.g)}}}if(n.length===0)return null;let o=i.length,s=new x;t.use(s),s.setAttribute(`position`,new p(n,3)),s.setAttribute(`aColor`,new p(r,3));let c=new Float32Array(o).fill(1);s.setAttribute(`aDim`,new u(c,1)),s.computeBoundingSphere();let l=t.use(new a({uniforms:{uConverge:{value:0},uNear:{value:1},uFar:{value:4e3},uGain:{value:.24}},vertexShader:yt,fragmentShader:bt,blending:2,depthWrite:!1,depthTest:!1,transparent:!0})),d=new T(s,l);d.renderOrder=4,d.frustumCulled=!1;let f=i,m=new Float32Array(o).fill(1),h=null,g=s.getAttribute(`aDim`),_=t.release(),v=()=>{for(let e=0;e<o;e++)c[e]=m[e]*Z(f[e],h);g.needsUpdate=!0};return{object:d,setUniform(e,t){l.uniforms[e]&&(l.uniforms[e].value=t)},setFocus(e){h=e,v()},setMode(e,t,n){let r=t.wormholes[n];for(let t=0;t<o;t++)m[t]=e===`all`?1:e===`worm`&&r?+(f[t]===r.a||f[t]===r.b):.14;v()},dispose:_}}var Ct=new S(1,.62,.24),wt=190,Tt=`
${M}
