...
`;function Uu(e,t){let n=vu(e),r=n.length,i=new Ei(1,32,20),a=new ca;a.index=i.index,a.setAttribute(`position`,i.getAttribute(`position`)),a.instanceCount=r;let o=new Float32Array(r*3),s=new Float32Array(r*3),c=new Float32Array(r*3),l=new Float32Array(r*3),u=new Float32Array(r*3),d=new Float32Array(r*4),f=new Float32Array(r*2);n.forEach((e,t)=>{o.set(e.p,t*3),s.set(e.center,t*3),c.set(e.axis,t*3),l.set(e.start,t*3),u.set(e.color,t*3),d.set([e.period,e.ignite,e.bodyR,e.seed],t*4),f.set([e.kelvin,1],t*2)}),a.setAttribute(`iPos`,new Gr(o,3)),a.setAttribute(`iCenter`,new Gr(s,3)),a.setAttribute(`iAxis`,new Gr(c,3)),a.setAttribute(`iStart`,new Gr(l,3)),a.setAttribute(`iColor`,new Gr(u,3)),a.setAttribute(`iOrb`,new Gr(d,4)),a.setAttribute(`iMeta`,new Gr(f,2)),a.boundingSphere=new ur(new U,1e6);let p=()=>({uT:{value:0},uConverge:{value:+!!t},uProjScale:{value:1e3},uNear:{value:1},uFar:{value:4e3},uBob:{value:t?0:1.35}}),m=new Fi({uniforms:{...p(),uIgniteMs:{value:700},uLitFloor:{value:+!!t},uGain:{value:Iu.star}},vertexShader:Lu,fragmentShader:Ru,transparent:!0,depthTest:!0,depthWrite:!0}),h=new Vr(a,m);h.renderOrder=9,h.frustumCulled=!1;let g=e=>{let[t,n]=e.split(`.`),r=Number(t);return r<100&&(r+=2e3),r*12+Number(n)},_=1/0,v=-1/0;for(let e of n)for(let t of e.s.ev??[]){let e=g(t.y);Number.isFinite(e)&&(e<_&&(_=e),e>v&&(v=e))}let y=Math.max(1,v-_),b=e=>{let t=g(e);return Number.isFinite(t)?Math.min(.999,Math.max(0,(t-_)/y)):.5},x=[];for(let e of n){let t=e.s.ev??[];t.forEach((n,r)=>x.push({d:e,idx:r,own:+!!n.o,fresh:b(n.y),count:t.length}))}let S=x.length,C=new Float32Array(S*3),w=new Float32Array(S*3),T=new Float32Array(S*3),E=new Float32Array(S*3),D=new Float32Array(S*3),ee=new Float32Array(S*3),O=new Float32Array(S*4),k=new Float32Array(S*4),A=new Float32Array(S).fill(1),j=new Float32Array(S),M=new Int32Array(S),te=[],N=new Map;n.forEach((e,t)=>N.set(e,t)),x.forEach((e,t)=>{let n=e.d,r=e.idx*2654435761%1e3/1e3-.5,[i,a]=Gu(n.sysU,n.sysV,n.sysAxis,r*.22),o=Nu+e.idx*Pu,s=7+2.4*o**1.5,c=(e.idx*137.508+n.seed*31.7)*Math.PI/180,l=Fu+.115*(e.idx*7919%100/100);C.set(i,t*3),w.set(a,t*3),T.set(n.p,t*3),E.set(n.center,t*3),D.set(n.axis,t*3),ee.set(n.color,t*3),O.set([o,c,s,l],t*4),k.set([e.own*2+e.fresh,n.seed,n.bodyR,n.period],t*4),M[t]=N.get(n),te.push({star:n,ev:n.s.ev[e.idx],index:t,u:i,v:a,orbitR:o,phase:c,period:s,radius:l,own:e.own===1})});let ne=new Ei(1,20,14),re=new ca;re.index=ne.index,re.setAttribute(`position`,ne.getAttribute(`position`)),re.instanceCount=S,Wu(re,{pU:C,pV:w,pStarPos:T,pStarCenter:E,pStarAxis:D,pColor:ee,pOrb:O,pMeta:k,pDim:A,pSel:j});let ie=new Fi({uniforms:{...p(),uGain:{value:Iu.planet}},vertexShader:zu,fragmentShader:Bu,transparent:!0,depthTest:!0,depthWrite:!0}),ae=new Vr(re,ie);ae.renderOrder=9,ae.frustumCulled=!1;let oe=new Float32Array(432);for(let e=0;e<72;e++){let t=e/72*Math.PI*2,n=(e+1)/72*Math.PI*2;oe.set([Math.cos(t),Math.sin(t),0,Math.cos(n),Math.sin(n),0],e*6)}let se=new ca;se.setAttribute(`position`,new q(oe,3)),se.instanceCount=S,Wu(se,{pU:C,pV:w,pStarPos:T,pStarCenter:E,pStarAxis:D,pColor:ee,pOrb:O,pMeta:k,pDim:A,pSel:j});let ce=new Fi({uniforms:{...p(),uGain:{value:Iu.ring}},vertexShader:Vu,fragmentShader:Hu,transparent:!0,blending:2,depthTest:!1,depthWrite:!1}),le=new fi(se,ce);le.renderOrder=8.5,le.frustumCulled=!1;let P=new _n;P.add(le,h,ae);let ue=[m,ie,ce],de=a.getAttribute(`iMeta`),fe=re.getAttribute(`iDim`),pe=se.getAttribute(`iDim`),me=re.getAttribute(`iSel`),he=se.getAttribute(`iSel`),ge=-1;return{group:P,data:n,planets:te,setSelected(e){e!==ge&&(ge>=0&&(j[ge]=0),ge=e>=0&&e<S?e:-1,ge>=0&&(j[ge]=1),me.needsUpdate=!0,he.needsUpdate=!0)},setUniform(e,t){for(let n of ue)n.uniforms[e]&&(n.uniforms[e].value=t)},setMode(e,t,i){let a=n.map(n=>Mu(n.s,e,t,i));for(let e=0;e<r;e++)f[e*2+1]=a[e];de.needsUpdate=!0;for(let e=0;e<S;e++)A[e]=a[M[e]];fe.needsUpdate=!0,pe.needsUpdate=!0},dispose(){i.dispose(),ne.dispose(),a.dispose(),re.dispose(),se.dispose();for(let e of ue)e.dispose()}}}function Wu(e,t){e.setAttribute(`iU`,new Gr(t.pU,3)),e.setAttribute(`iV`,new Gr(t.pV,3)),e.setAttribute(`iStarPos`,new Gr(t.pStarPos,3)),e.setAttribute(`iStarCenter`,new Gr(t.pStarCenter,3)),e.setAttribute(`iStarAxis`,new Gr(t.pStarAxis,3)),e.setAttribute(`iColor`,new Gr(t.pColor,3)),e.setAttribute(`iOrb`,new Gr(t.pOrb,4)),e.setAttribute(`iMeta`,new Gr(t.pMeta,4)),e.setAttribute(`iDim`,new Gr(t.pDim,1)),e.setAttribute(`iSel`,new Gr(t.pSel,1)),e.boundingSphere=new ur(new U,1e6)}function Gu(e,t,n,r){let i=Math.cos(r),a=Math.sin(r),o=[e[0]*i+n[0]*a,e[1]*i+n[1]*a,e[2]*i+n[2]*a],s=Math.hypot(o[0],o[1],o[2])||1;return o[0]/=s,o[1]/=s,o[2]/=s,[o,[t[0],t[1],t[2]]]}var Ku=`
${eu}
${tu}
